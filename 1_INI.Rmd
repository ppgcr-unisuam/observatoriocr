    ...
    doi_artigos_completos_sucupira$DOI[i] <-
      sucupira.raw$`Valor do Item de Detalhamento`[which(
        and(
          ...
          sucupira.raw$`Item de Detalhamento` == "Número do DOI"
        ) == TRUE
      )]
  }
...
if(!has.eventos.ppg){
  doi_with_altmetric_eventos = data.frame()
  doi_without_altmetric_eventos = data.frame()
  references_eventos = data.frame()
  doi_with_altmetric_eventos_impacto = data.frame()
  doi_without_altmetric_eventos_impacto = data.frame()
  references_eventos_impacto = data.frame()
}
...
doi_with_altmetric_artigos <- get_metrics(doi_with_altmetric = doi_with_altmetric, doi_without_altmetric = NULL, citescore, scimago, qualis)
doi_without_altmetric_artigos <- get_metrics(doi_with_altmetric = NULL, doi_without_altmetric = doi_without_altmetric, citescore, scimago, qualis)

# obtain formatted references
formatted_citations <-
  rcrossref::cr_cn(
    c(doi_with_altmetric_artigos$doi, doi_without_altmetric_artigos$doi),
    format = "text",
    raw = TRUE,
...
# store to use downstream
doi_with_altmetric_resumos <- get_metrics(doi_with_altmetric = doi_with_altmetric, doi_without_altmetric = NULL, citescore, scimago, qualis)
doi_without_altmetric_resumos <- get_metrics(doi_with_altmetric = NULL, doi_without_altmetric = doi_without_altmetric, citescore, scimago, qualis)

# obtain formatted references
formatted_citations <-
  rcrossref::cr_cn(
    c(doi_with_altmetric_resumos$doi, doi_without_altmetric_resumos$doi),
    format = "text",
    raw = TRUE,
    style = "american-medical-association"
  )
...
# store to use downstream
doi_with_altmetric_preprints <- get_metrics(doi_with_altmetric = doi_with_altmetric, doi_without_altmetric = NULL, citescore, scimago, qualis)
doi_without_altmetric_preprints <- get_metrics(doi_with_altmetric = NULL, doi_without_altmetric = doi_without_altmetric, citescore, scimago, qualis)

# obtain formatted references
formatted_citations <-
  rcrossref::cr_cn(
    c(doi_with_altmetric_preprints$doi, doi_without_altmetric_preprints$doi),
    format = "text",
    raw = TRUE,
    style = "american-medical-association"
  )
...
```{r metrics-livros, results = "hide", cache = TRUE, cache.path = "cache/livros/", eval = has.livros.ppg}
# read data
data.sheet <-
  data.frame(readxl::read_excel(
    "PPG/Produção.xlsx",
...
# store to use downstream
doi_with_altmetric_livros <- get_metrics(doi_with_altmetric = doi_with_altmetric, doi_without_altmetric = NULL, citescore, scimago, qualis)
doi_without_altmetric_livros <- get_metrics(doi_with_altmetric = NULL, doi_without_altmetric = doi_without_altmetric, citescore, scimago, qualis)

# obtain formatted references
formatted_citations <-
  rcrossref::cr_cn(
    c(doi_with_altmetric_livros$doi, doi_without_altmetric_livros$doi),
    format = "text",
    raw = TRUE,
    style = "american-medical-association"
  )
...
# store to use downstream
doi_with_altmetric_capitulos <- get_metrics(doi_with_altmetric = doi_with_altmetric, doi_without_altmetric = NULL, citescore, scimago, qualis)
doi_without_altmetric_capitulos <- get_metrics(doi_with_altmetric = NULL, doi_without_altmetric = doi_without_altmetric, citescore, scimago, qualis)

# obtain formatted references
formatted_citations <-
  rcrossref::cr_cn(
    c(doi_with_altmetric_capitulos$doi, doi_without_altmetric_capitulos$doi),
    format = "text",
    raw = TRUE,
    style = "american-medical-association"
  )
...
```{r metrics-eventos, results = "hide", cache = TRUE, cache.path = "cache/eventos/", eval = has.eventos.ppg}
# read data
data.sheet <-
  data.frame(readxl::read_excel(
    "PPG/Produção.xlsx",
...
# store to use downstream
doi_with_altmetric_eventos <- get_metrics(doi_with_altmetric = doi_with_altmetric, doi_without_altmetric = NULL, citescore, scimago, qualis)
doi_without_altmetric_eventos <- get_metrics(doi_with_altmetric = NULL, doi_without_altmetric = doi_without_altmetric, citescore, scimago, qualis)

# obtain formatted references
formatted_citations <-
  rcrossref::cr_cn(
    c(doi_with_altmetric_eventos$doi, doi_without_altmetric_eventos$doi),
    format = "text",
    raw = TRUE,
    style = "american-medical-association"
  )
...
write.table(doi_with_altmetric_artigos, "doi_with_altmetric_artigos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_with_altmetric_resumos, "doi_with_altmetric_resumos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_with_altmetric_preprints, "doi_with_altmetric_preprints.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_with_altmetric_livros, "doi_with_altmetric_livros.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_with_altmetric_capitulos, "doi_with_altmetric_capitulos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_with_altmetric_eventos, "doi_with_altmetric_eventos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")

write.table(doi_without_altmetric_artigos, "doi_without_altmetric_artigos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_without_altmetric_resumos, "doi_without_altmetric_resumos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_without_altmetric_preprints, "doi_without_altmetric_preprints.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_without_altmetric_livros, "doi_without_altmetric_livros.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_without_altmetric_capitulos, "doi_without_altmetric_capitulos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
write.table(doi_without_altmetric_eventos, "doi_without_altmetric_eventos.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t", dec = ",")
