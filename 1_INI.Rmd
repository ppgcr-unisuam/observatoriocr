...
```{r save, results = "hide", eval = TRUE}
write.table(doi_with_altmetric_all, "doi_with_altmetric_all.tsv", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)

write.table(doi_without_altmetric_all, "doi_without_altmetric_all.tsv", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)

write.table(doi_all, "doi_all.tsv", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
```
