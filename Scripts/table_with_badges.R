...
for (i in 1:dim(doi_sort)[1]) {
	...
	# add link
	cat(paste0("DOI: [", doi_sort$doi[i], "](", doi_sort$url[i], "){target=\"_blank\"}"))
	cat("\n\n")
	...
	cat("<a style=\"display: inline-block; float: left; margin:0.1em 0.3em 0.1em 0.3em;\" class=\"plumx-plum-print-popup\" href=\"https://plu.mx/plum/a/?doi=", 
		doi_sort$doi[i], "\" data-size=\"medium\" data-site=\"plum\"></a>", sep = "")
	# add SJR
...
if (length(my_dois_works) != 0) {
	for (i in 1:dim(my_dois_works)[1]) {
		...
		# add link
		cat(paste0("DOI: [", my_dois_works$doi[i], "](https://doi.org/", my_dois_works$doi[i], "){target=\"_blank\"}"))
		cat("\n\n")
		# initialize the DIV element for the badges
		cat("<div style=\"vertical-align: middle;\">")
		# add Altmetric badge
		...
		cat("<style>.ppp-medium{display: inline-block; float: left;}</style>")
		cat("<a style=\"display: inline-block; float: left; margin:0.1em 0.3em 0.1em 0.3em;\" class=\"plumx-plum-print-popup\" href=\"https://plu.mx/plum/a/?doi=", 
			my_dois_works$doi[i], "\" data-size=\"medium\" data-site=\"plum\"></a>", sep = "")
		# add SJR
