...
knitr::kable(
  ...
  booktabs = TRUE,
  linesep = "",
  caption = ifelse(knitr::is_html_output(), "", "2.5.1 Estrutura curricular")
) %>% kableExtra::kable_styling(
  bootstrap_options = c("striped", "hover", "condensed", "responsive"),
  latex_options = c("striped", "repeat_header", "HOLD_position"),
  latex_table_env = "tabularx",
...
# filter by responsável and categoria
turmas.doc <- turmas %>%
  dplyr::filter(Responsável == "Sim") %>%
  dplyr::filter(Categoria == "Docente")
...
table.2.5.1 <- gtsummary::tbl_stack(table.all)
