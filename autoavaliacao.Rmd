...
```{r 1-1-2-disciplinas, eval = has.sucupira.files, echo = FALSE, include = FALSE}
...
```{r 1-1-2-disciplina-msc, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = !sjmisc::is_empty(table.msc)}
if(knitr::is_html_output()) {
...
if (knitr::is_html_output()) {
  ...
  knitr::kable(
    ...
    format = "html",
    linesep = "",
    caption = "Disciplinas do Mestrado"
  ) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = TRUE,
    position = "center"
  ...
  tinytable::tt(
    ...
    style = "bootstrap",
    align = "l",
    caption = ifelse(knitr::is_html_output(), "", "Disciplinas do Mestrado")
  ) %>%
    tinytable::theme_tt("multipage", rowhead = 1, latex_float = "H")
}
...
```{r 1-1-2-disciplinas-dsc, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = !sjmisc::is_empty(table.dsc)}
if(knitr::is_html_output()) {
...
if (knitr::is_html_output()) {
  ...
  knitr::kable(
    ...
    format = "html",
    linesep = "",
    caption = "Disciplinas do Doutorado"
  ) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = TRUE,
    position = "center"
  ...
  tinytable::tt(
    ...
    style = "bootstrap",
    align = "l",
    caption = ifelse(knitr::is_html_output(), "", "Disciplinas do Doutorado")
  ) %>%
    tinytable::theme_tt("multipage", rowhead = 1, latex_float = "H")
}
...
```{r 1-1-3-laboratorios-equipamentos, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = has.laboratorios}
# Initialize all sheets
...
for (j in 1:length(abas)) {
  ...
  if (knitr::is_latex_output()) {
    ...
    kable_table <- gtsummary::as_kable_extra(
      ...
      booktabs = TRUE,
      linesep = "",
      caption = ifelse(knitr::is_html_output(), "", paste0("1.1.3 Infraestrutura: ", name)),
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "scale_down", "HOLD_position"),
      full_width = TRUE
    )
...
```{r estabilidade-corpo-docente, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "1.2.3 Estabilidade do corpo docente permanente"),
    bootstrap_options = c("basic", "hover", "condensed", "responsive"),
    latex_options = c("basic", "scale_down", "HOLD_position"),
    full_width = TRUE
  )
...
```{r 1-4-1-metodologia, eval = has.metodologia, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
# initialize all sheets
...
for (j in 1:length(abas)) {
  ...
  if (knitr::is_html_output()) {
    # print end of tab rows
    cat(
      '<br><a style="float:right" href="#top"><b>Início &nbsp;</b>', fontawesome::fa("circle-arrow-up"),'</a><br>'
    )
  } else {
    cat('\\FloatBarrier')
  }
...
```{r 1-4-1-resultados, eval = has.autoavaliacao, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
# initialize all sheets
