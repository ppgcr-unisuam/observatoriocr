...
# get ID da Produção
ID <- sucupira.df.bibl$`ID da Produção`
...
producao.ano <- table.bib.long %>%
  ...
  dplyr::filter(Ano != "Ano") %>%
  dplyr::count(Ano)
colnames(producao.ano) <- c("Ano", "Número de trabalhos de discentes publicados em artigos/livros/capítulos")
...
# calculate ratio
razao.ano$Razão <- razao.ano$`Número de trabalhos de discentes publicados em artigos/livros/capítulos` / razao.ano$`Número de titulações do Programa`
...
# rename columns
colnames(razao.ano) <- c("Ano", "Razão (trabalhos publicados artigos/livros/capítulos por titulação)")

# change all column types to factors
table.razao.long <- razao.ano %>%
  dplyr::mutate(dplyr::across(Ano, as.factor))
table.razao.long <- razao.ano %>%
  dplyr::mutate(dplyr::across("Razão (trabalhos publicados artigos/livros/capítulos por titulação)", as.numeric))
...
if (knitr::is_latex_output() && !sjmisc::is_empty(table.2.2.2.a)) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Número de trabalhos de discentes publicados (artigos/livros/capítulos)")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
...
if (knitr::is_latex_output() && !sjmisc::is_empty(table.2.2.2.c)) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Razão (trabalhos publicados em artigos/livros/capítulos por titulação)")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
