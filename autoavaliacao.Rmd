...
# get Ano titulação e País from each element in sucupira.list
...
# bind_cols from anos.titulos and pais.titulos based on Ano
...
table.perm.compl.long <- rbind(
  ...
  data.frame(
    "Ano" = rep(paste0(min(quadrienal.vigente), "-", max(quadrienal.vigente)), times = dim(table.doc)[1]),
    "País de Titulação" = rep("País", times = dim(table.doc)[1]),
    "Tempo de Titulação, anos" = rep(NA, times = dim(table.doc)[1]),
    check.names = FALSE
  )
)
...
if (knitr::is_latex_output() && !sjmisc::is_empty(table.1.2.2)) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Coerência Acadêmica do Corpo Docente Permanente à Proposta do Programa - Área de Conhecimento, Ano e País (Maior Titulação)")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
...
if (knitr::is_latex_output() && !sjmisc::is_empty(table.1.2.2)) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Coerência Acadêmica do Corpo Docente Colaborador à Proposta do Programa - Área de Conhecimento, Ano e País (Maior Titulação)")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
