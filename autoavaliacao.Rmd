...
# print tables
print(
  knitr::kable(cursos, align = c("l"), escape = FALSE, format = "html") %>% kableExtra::kable_styling(
...
print(
  knitr::kable(area.ativas, align = c("l", rep(
...
print(
  knitr::kable(linhas.atual, align = c("l", rep(
...
print(
  knitr::kable(table.projetos, align = c("l", rep(
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = "3.1.1 Avaliação quantitativa dos impactos do PPG",
