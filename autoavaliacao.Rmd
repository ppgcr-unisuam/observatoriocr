...
# if still duplicated, keep Situacão = Concluído
...
for (i in 1:length(ids)) {
  ...
  output$Bolsa[i] <- paste0(na.omit(tools::toTitleCase(tolower(unique(data$Bolsa)))), collapse = "; ")
  output$Auxílio[i] <- paste0(na.omit(tools::toTitleCase(tolower(unique(data$Auxílio)))), collapse = "; ")
...
for (i in 1:length(lista.AC.LP)) {
  ...
  knit_expanded <- paste0(
    ...
    "      position = 'center'\n",
    "    ) %>% \n",
    "    kableExtra::column_spec(column = 1:ncol(lista.AC.LP[[", i, "]]), width = paste0(c(0.02,0.21,0.08,0.16,0.20,0.20,0.13)*(21-3-3), 'cm')) %>% \n",
    "    kableExtra::column_spec(column = 1, bold = TRUE) %>% \n",
    "    kableExtra::row_spec(row = 0, bold = TRUE)\n",
    "} else {\n",
    "  # use tinytable for LaTeX output\n",
    ...
    "  tinytable::tt(\n",
    "    linhas.atual,\n",
    "    width = c(0.02,0.21,0.08,0.16,0.20,0.20,0.13)*(21-3-3),\n",
    "    style = 'bootstrap',\n",
    "    align = 'l',\n",
    "    caption = '", caption, "',\n",
    "    row.names = FALSE\n",
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Coerência Acadêmica do Corpo Docente (Colaboradores, Visitantes e Pós-Docs) à Proposta do Programa")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
