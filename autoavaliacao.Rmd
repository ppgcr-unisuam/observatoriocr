...
cat("## **Autoavaliação** {#procedimentos .tabset}")
```
...
```{r, eval = knitr::is_html_output()}
cat("## **Avaliação CAPES** {#documentos .tabset}")
```
...
table.projetos[, 2] <- as.vector(unlist(lapply(table.projetos[, 2], FUN = stringr::str_to_title)))
table.projetos[, 3] <- as.vector(unlist(lapply(table.projetos[, 3], FUN = stringr::str_to_title)))
table.projetos[, 4] <- as.vector(unlist(lapply(table.projetos[, 4], FUN = stringr::str_to_sentence)))
table.projetos[, 5] <- as.vector(unlist(lapply(table.projetos[, 5], FUN = stringr::str_to_title)))
table.projetos[, 6] <- as.vector(unlist(lapply(table.projetos[, 6], FUN = stringr::str_to_sentence)))
...
# Escape ampersand in table data
try(table.projetos <- apply(table.projetos, 2, function(x) gsub("&", "e", x)), silent = TRUE)
...
colnames(table.doc) <- stringr::str_to_title(c(head(colnames(table.doc), -1), "N (Quadriênio)"))

# add column totals
table.doc <- rbind(table.doc, colSums(table.doc))
rownames(table.doc) <- stringr::str_to_title(c(head(rownames(table.doc), -1), "N (Quadriênio)"))
...
if (any(table.all$`Categoria do Membro do Projeto` == "Pós-Doc")) {
  ...
  colnames(table.posdoc) <- stringr::str_to_title(c(head(colnames(table.posdoc), -1), "N (Quadriênio)"))

  # add column totals
  table.posdoc <- rbind(table.posdoc, colSums(table.posdoc))
  rownames(table.posdoc) <- stringr::str_to_title(c(head(rownames(table.posdoc), -1), "N (Quadriênio)"))
...
if(knitr::is_html_output()) {
  cat("##### **Síntese** {#coerencia-quantitativo}")
  cat("\n")
}
...
print(
  knitr::kable(table.ac, align = c("l", rep("c", ncol(table.ac) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.pp, align = c("l", rep("c", ncol(table.pp) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.posdoc, align = c("l", rep("c", ncol(table.posdoc) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.doc.1, align = c("l", rep("c", ncol(table.doc.1) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
  )
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.doc.3, align = c("l", rep("c", ncol(table.doc.3) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
  )
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.doc.5, align = c("l", rep("c", ncol(table.doc.5) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
  )
...
if (dim(disciplinas.raw)[1] != 0) {
  ...
  # Print the table
  print(
    knitr::kable(turmas.docentes, align = c("l", rep("c", ncol(turmas.docentes) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
    )
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.lp, align = c("l", rep("c", ncol(table.lp) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% 
    kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
...
print(
  knitr::kable(table.prd, align = c("l", rep("c", ncol(table.prd) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% 
    kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
...
options(nitr.kable.NA = '')
print(
  knitr::kable(table.aut, align = c("l", rep("c", ncol(table.aut) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% 
    kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
...
options(nitr.kable.NA = '')
print(
  knitr::kable(table.tcc, align = c("l", rep("c", ncol(table.tcc) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% 
    kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
...
options(nitr.kable.NA = '')
print(
  knitr::kable(table.bib, align = c("l", rep("c", ncol(table.bib) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% 
    kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
...
options(nitr.kable.NA = '')
print(
  knitr::kable(table.tec, align = c("l", rep("c", ncol(table.tec) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% 
    kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
...
síntese.ano <- dplyr::bind_cols(
      ...
      Altmetric = as.numeric(doi_all$altmetric_score),
      Citações = as.numeric(doi_all$citations),
      Facebook = as.numeric(doi_all$cited_by_fbwalls_count),
      Blogs = as.numeric(doi_all$cited_by_feeds_count),
      'Google+' = as.numeric(doi_all$cited_by_gplus_count),
      Notícias = as.numeric(doi_all$cited_by_msm_count),
      Posts = as.numeric(doi_all$cited_by_posts_count),
      Reddit = as.numeric(doi_all$cited_by_rdts_count),
      X = as.numeric(doi_all$cited_by_tweeters_count),
      'YouTube/Vimeo' = as.numeric(doi_all$cited_by_videos_count),
      Patentes = as.numeric(doi_all$cited_by_patents_count),
      Mendeley = as.numeric(doi_all$mendeley),
      'Acesso aberto' = as.numeric(doi_all$is_oa)
          )
