...
# print tables
print(
  knitr::kable(cursos, align = c("l", rep("c", ncol(
    cursos
  ) - 2), "r"), escape = FALSE, format = "html") %>% kableExtra::kable_styling(
...
# Summarize data using tbl_summary from gtsummary
table.2 <- gtsummary::tbl_summary(
  financiadores,
  by = "Ano",
  ...
  gtsummary::modify_header(label = "**Ano**") %>%
...
```{r 3-2-1-data, eval = any(has.producao.ppg, has.producao.sucupira)}
