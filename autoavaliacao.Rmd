...
colnames(table.princ.long) <- c("Ano", "Relação Orientadores - Matriculados")
...
table.princ.gt <- gtsummary::tbl_summary(
  ...
  gtsummary::remove_row_type(
    variables = c('Relação Orientadores - Matriculados'),
    type = "level",
...
colnames(table.princ.long) <- c("Ano", "Relação Orientadores - Titulados")
...
table.princ.gt <- gtsummary::tbl_summary(
  ...
  gtsummary::remove_row_type(
    variables = c('Relação Orientadores - Titulados'),
    type = "level",
    level_value = ("Orientador")
  ) %>%
  gtsummary::modify_column_hide(columns = paste0("stat_", as.character(length(quadrienal.vigente) + 1)))
