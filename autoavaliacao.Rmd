...
colnames(table.doc) <- stringr::str_to_title(c(head(colnames(table.doc), -1), "N"))

# add column totals
table.doc <- rbind(table.doc, colSums(table.doc))
rownames(table.doc) <- stringr::str_to_title(c(head(rownames(table.doc), -1), "N"))
...
if (any(table.all$`Categoria do Membro do Projeto` == "Pós-Doc")) {
  ...
  colnames(table.posdoc) <- stringr::str_to_title(c(head(colnames(table.posdoc), -1), "N"))

  # add column totals
  table.posdoc <- rbind(table.posdoc, colSums(table.posdoc))
  rownames(table.posdoc) <- stringr::str_to_title(c(head(rownames(table.posdoc), -1), "N"))
