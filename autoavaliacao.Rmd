...
for (i in 1:length(lista.kw)) {
  # Define table caption
  caption <- paste0('Palavras-chave mais frequentes por Linha de Pesquisa - Linhas de Pesquisa: ', toupper(lista.kw[[i]]$`Linha 1`), ' <> ', toupper(lista.kw[[i]]$`Linha 2`))
...
LogRatio: Compara o risco relativo de duas palavras ou grupos de palavras. É uma forma intuitiva de ver diferenças. 
...
Um filtro de significância é aplicado, de modo que apenas palavras com valores diferentes de zero são exibidas.
