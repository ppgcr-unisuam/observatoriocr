...
if (!sjmisc::is_empty(id.TCC) && length(unique(bancas$`Linha de Pesquisa`[!is.na(bancas$Título) & bancas$Título != ""])) >= 2) {
  # loop over each ID
...
cat("\\vspace{0.5em}\n",
    "\\textbf{Fontes}: \\href{https://sucupira.capes.gov.br/sucupira/}{\\textbf{Plataforma Sucupira}}, ",
