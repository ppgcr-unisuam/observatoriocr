...
# drop columns
bolsistas.tcc <- bolsistas.tcc %>% select("Ano de Defesa", "Tipo de Trabalho de Conclusão", "Nome do Autor", "Nome do Trabalho de Conclusão", "Nome do Financiador")

# drop NA values in "Quantidade de Meses"
bolsistas.tcc <- bolsistas.tcc[complete.cases(bolsistas.tcc), ]

if (dim(bolsistas.tcc)[1] != 0) {
  ids <- order(bolsistas.tcc$'Ano de Defesa', bolsistas.tcc$'Tipo de Trabalho de Conclusão', decreasing = TRUE)
