...
vigentes.raw <-
  read_excel(
    "../PPGCR Unisuam/CEP-UNISUAM.xlsx",
    sheet = "Vigentes",
    col_types = c("text")
  )
...
### **Dissertações e teses financiadas**
...
# selecting those with COVID in the title
doi_unique <-
  doi_unique[grep(paste(tolower(pandemia), collapse = "|"), tolower(doi_unique$title)),]
my_dois_works <-
  doi_unique[grep(paste(tolower(pandemia), collapse = "|"), tolower(my_dois_works$title)),]
