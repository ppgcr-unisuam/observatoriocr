...
projetos <- projetos.all[grep(tolower("COVID"), tolower(projetos.all$`Nome do Projeto de Pesquisa`)), ]
...
# selecting those with COVID in the title
financiadores <-
  financiadores[grep(tolower("COVID"), tolower(financiadores$`Título do projeto`)), ]
fonte <-
  fonte[grep(tolower("COVID"), tolower(financiadores$`Título do projeto`)), ]
...
# selecting those with COVID in the title
tccs <- tcc.all[grep(tolower("COVID"), tolower(tcc.all$`Nome do Trabalho de Conclusão`)), ]
...
# selecting those with COVID in the title
all.dois <- all.dois[grep(tolower("COVID"), tolower(all.dois$Título)), ]
