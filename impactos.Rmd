...
```{r pandemia-artigos-periodicos-icon, eval = any(has.artigos.completos.ppg, has.artigos.completos.sucupira)}
# bind sources
try(doi_with_altmetric <- c(doi_with_altmetric_artigos_impacto, doi_with_altmetric_resumos_impacto), silent = TRUE)
try(doi_without_altmetric <- c(doi_without_altmetric_artigos_impacto, doi_without_altmetric_resumos_impacto), silent = TRUE)
try(references <- c(references_artigos_impacto, references_resumos_impacto), silent = TRUE)
...
```{r pandemia-preprints-icon, eval = has.preprints.ppg}
# bind sources
...
```{r pandemia-livros-icon, eval = has.livros.ppg}
# bind sources
...
```{r pandemia-capitulos-icon, eval = has.capitulos.ppg}
# bind sources
...
```{r pandemia-trabalhos-anais-icon, eval = has.anais.ppg}
# bind sources
