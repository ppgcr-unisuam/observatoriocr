...
if(file.exists("PPG/Images/logo-programa.png")) {
  cat('<img src=\"PPG/Images/logo-programa.png\" height="50vw" align=\"center\"/>')
  has.logo.ppg <- TRUE
} else {
  has.logo.ppg <- FALSE
}
...
plot.1 <- plot.1 %>% plotly::layout(
  title = list(
    text = "Atenção e Visibilidade (Altmetric attention score)",
    x = 0.5,
    xanchor = 'center',
    font = list(size = '100vw', color = 'white')
  ),
...
# plot 5 (summay table for Altmetric breackdown)
