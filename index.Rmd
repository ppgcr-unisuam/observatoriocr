...
<!--script for printing landing page buttons-->
<div style="text-align: center">
  <!-- Programa -->
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="programa.html" title="Programa" target="_self" class="btn"><i class="fa fa-university fa-solid fa-2x"></i>&nbsp;&nbsp;Programa</a>
   <!-- Pessoas -->
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="pessoas.html" title="Pessoas" target="_self" class="btn"><i class="fa fa-user-graduate fa-solid fa-2x"></i>&nbsp;&nbsp;Pessoas</a>
  <!-- Produções --> 
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="producoes.html" title="Produções" target="_self" class="btn"><i class="fa fa-book fa-solid fa-2x"></i>&nbsp;&nbsp;Produções</a>
</div>

<div style="text-align: center">
  <!-- Destaques -->
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="destaques.html" title="Destaques" target="_self" class="btn"><i class="fa fa-trophy fa-solid fa-2x"></i>&nbsp;&nbsp;Destaques</a>
   <!-- Impacto -->
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="impacto.html" title="Impacto" target="_self" class="btn"><i class="fa fa-users fa-solid fa-2x"></i>&nbsp;&nbsp;Impacto</a>
  <!-- Autoavaliaçào --> 
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="autoavaliacao.html" title="Autoavaliação" target="_self" class="btn"><i class="fa fa-clipboard-check fa-solid fa-2x"></i>&nbsp;&nbsp;Autoavaliação</a>
</div>

<div style="text-align: center">
  <!-- Galeria -->
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="galeria.html" title="Galeria" target="_self" class="btn"><i class="fa fa-images fa-solid fa-2x"></i>&nbsp;&nbsp;Galeria</a>
   <!-- News -->
  <a style="background-color: #2C3E50; border-radius: 1.00em; margin:0.3125em; font-size:1.25em;" role="button" href="news.html" title="News" target="_self" class="btn"><i class="fa fa-newspaper-o fa-solid fa-2x"></i>&nbsp;&nbsp;News</a>
</div>
...
```{r discentes-região, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis", out.width="80%"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
