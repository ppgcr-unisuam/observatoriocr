...
bs_carousel(id = "wordcloud",
            ...
            use_controls = TRUE) %>%
  bs_append(
    content = bs_carousel_image(src = "index_files/figure-html/Projetos.png"),
    caption = bs_carousel_caption("Projetos de Pesquisa")
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "index_files/figure-html/TCC.png"),
    caption = bs_carousel_caption("Dissertações e Teses")
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "index_files/figure-html/Produções.png"),
    caption = bs_carousel_caption("Produção Bibliográfica")
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "index_files/figure-html/News e Blogs.png"),
    caption = bs_carousel_caption("News e Blogs")
  )
```
...
<h1> [**Projetos por linha de pesquisa**](programa.html#linhas-pesquisa) </h1>
...
legend("topleft",
  legend = linhas.curr,
  fill = brewer.pal(n = length(linhas.curr), name = "Set3"),
  text.col = "white",
  box.lwd = 0,
  bty = "n",
  horiz = TRUE,
...
bs_carousel(id = "barplot-projetos",
            ...
            use_controls = TRUE) %>%
  bs_append(
    content = bs_carousel_image(src = "index_files/figure-html/sintese-projetos-1.png"),
    caption = bs_carousel_caption("Projetos por Linha de Pesquisa", "Quantidade")
  ) %>%
  bs_append(
    content = bs_carousel_image(src = "index_files/figure-html/sintese-projetos-2.png"),
    caption = bs_carousel_caption("Projetos por Linha de Pesquisa", "Proporção")
  )
```
