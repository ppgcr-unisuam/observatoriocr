...
```{r meta-observatorio, eval = all(!has.sucupira.files, !has.financiadores, !has.producao.ppg, !has.producao.sucupira, !has.discentes, !has.posdocs)}
...
shiny::HTML('<iframe id="scaled-frame" src="https://ppgcr-ppgdl.github.io/observatoriodl/" style="width:100%; height:600px; border:2px solid white;"></iframe>')
...
# We need a data frame giving a hierarchical structure. Lets consider the flare dataset
edges1 <-
  stats::aggregate(
    alluv.data$sucupira.raw..Linha.de.Pesquisa.,
    by = list(
...
table.5 <- data.frame(doi_all$journal, doi_all$SJR)
...
<center><img width="5%" height="5%" src="https://raw.githubusercontent.com/rstudio/hex-stickers/main/thumbs/RStudio.png"> Esta página foi desenvolvida em [**`r R.version$version.string`**](https://www.rstudio.com) usando [**R markdown**](https://rmarkdown.rstudio.com)
</center>
