...
```{r metrics-preprints, cache = TRUE}
# read data
...
```{r metrics-livros-capitulos, cache = TRUE}
# read data
sheet.ix <- "PI.livros"
data.sheet <-
  data.frame(read_excel(
