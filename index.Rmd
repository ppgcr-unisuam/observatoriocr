...
*Fontes:*
^1^ [**Plataforma Sucupira**](https://sucupira.capes.gov.br/sucupira/)
...
^2^ [**CNPq**](https://www.gov.br/cnpq/pt-br)
^3^ [**FAPERJ**](http://www.faperj.br)
^4^ **UNISUAM**
...
*Fontes:*
^1^ [**SCImago**](https://www.scimagojr.com)
^2^ [**WebQualis**](https://sucupira.capes.gov.br/sucupira/public/consultas/coleta/veiculoPublicacaoQualis/listaConsultaGeralPeriodicos.jsf)
^3^ **UNISUAM**
...
```{r conceitos, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis", out.width="100%"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
