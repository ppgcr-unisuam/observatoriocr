...
current.sucupira <- sucupira.list[[format(Sys.Date(), "%Y")]]
...
alluv.data <- alluv.data[order(alluv.data$sucupira.raw..Data.de.Início., decreasing = FALSE), ]
...
summ.AC.LP <- as.data.frame(table(alluv.data$sucupira.raw..Área.de.Concentração., alluv.data$sucupira.raw..Linha.de.Pesquisa.))
colnames(summ.AC.LP) <- c("source", "target", "value")

summ.LP.PP <- as.data.frame(table(alluv.data$sucupira.raw..Linha.de.Pesquisa., alluv.data$sucupira.raw..Nome.do.Projeto.de.Pesquisa.))
