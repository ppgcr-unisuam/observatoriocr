...
title(main = "Síntese dos Financiamentos",
      outer = TRUE,
      cex.main = 2)
```
...
```{r sintese-producao, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis", out.width="95%"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
