...
# this chunk requires additional data that may nnot be available
tryCatch(
  expr = {
    financiadores.raw <-
...
tryCatch(
  expr = {
    ...
    bs_carousel(id = "financiadores-carousel",
      ...
      bs_append(content = bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-6.png"))
