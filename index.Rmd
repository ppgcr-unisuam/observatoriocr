...
data.nac <- data.frame(
  name = names(sort(table(IES.nac), decreasing = TRUE)[1:top]),
...
title(main = paste0("Top-", top, " nacionais"),
      outer = TRUE,
      cex.main = 1.7)

# plot 4

data.inter <- data.frame(
  name = names(sort(table(IES.inter), decreasing = TRUE)[1:top]),
...
title(main = paste0("Top-", top, " internacionais"),
      outer = TRUE,
      cex.main = 1.7)
