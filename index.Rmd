...
doi_unique <-
  bind_rows(doi_unique_artigos,
            ...
            doi_unique_eventos)
table.6 <- 
  table.6 <- data.frame(doi_unique$published_on, doi_unique$score)
...
# plot 6 (violin plot of Altmetric por ano)
vioplot(as.numeric(table.6[, 2]) ~ as.numeric(table.6[, 1]),
        xlab = NA,
        ylab = "Altmetric")
...
text(
  x = (x1 + x2) / 2,
  y = (y1 + y2) / 2,
  labels = as.character(sum(table.6[, 2])),
  adj = 0.5
)

# plot 7 (top-10 journals)
...
# plot 8 (barplot of QUALIS e SJR)
...
bs_carousel(id = "producao-carousel",
  ...
  bs_append(content = bs_carousel_image(src = "index_files/figure-html/sintese-producao-8.png"))

cat('\n\n')
cat(
  "*Fontes:* [**WebQualis**](https://sucupira.capes.gov.br/sucupira/public/consultas/coleta/veiculoPublicacaoQualis/listaConsultaGeralPeriodicos.jsf), [**SJR**](https://www.scimagojr.com), [**Scopus**](https://www.scopus.com/home.uri), [**Altmetric**](https://www.altmetric.com), **PPG**"
)
