...
for (i in 1:dim(docentes)[1]) {
  ...
  cat('<center>\n')
  if (!is.na(docentes$'Google Scholar'[i])) {
    cat(
      paste0(
        '<iframe src="',
        docentes$'Google Scholar'[i],
  ...
  cat('\n</center>')
  cat('\n\n<!-- -->\n\n')
  cat('*Fontes:* [**Google Scholar**](https://scholar.google.com.br)')
  cat('\n\n<!-- -->\n\n')
