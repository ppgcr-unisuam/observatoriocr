...
for (i in 1:dim(endereco.raw)[1]) {
  if (length(grep('https://', endereco.raw[i, 2])) != 0) {
    endereco.raw[i, 2] <- paste0('<a href=\"', endereco.raw[i,2],'\" target=\"_blank\"', '>', '↗️' ,'</a>')
  }
}
...
print(
  knitr::kable(table, align = c("l", rep("c", ncol(table) - 2), "r"), escape = FALSE, format = "html") %>%
...
for (i in 1:dim(coordenadores)[1]) {
  table <- cbind(
    paste('<a href=\"mailto:', coordenadores$"E-mail"[i], '\">', coordenadores$'Nome'[i], '</a>', sep = ""),
    coordenadores$Categoria[i],
    paste(coordenadores$'Credenciamento'[i], "-", coordenadores$'Descredenciamento'[i], sep = "")
  )
...
for (i in 1:dim(docentes)[1]) {
  table <- cbind(
    paste('<a href=\"mailto:', docentes$"E-mail"[i], '\">', docentes$'Nome Docente'[i], '</a>', sep = ""),
    docentes$Categoria[i],
    paste(docentes$'Data de Admissão'[i], "-", docentes$'Data de Desligamento'[i], sep = ""),
    ifelse(!is.na(docentes$'Número do currículo Lattes'[i]),
           paste('<a href=\"http://lattes.cnpq.br/', docentes$'Número do currículo Lattes'[i], '\">',
                 docentes$'Número do currículo Lattes'[i], '</a>', sep = ""),
           docentes$'Número do currículo Lattes'[i]),
    ifelse(!is.na(docentes$ORCID[i]),
           paste('<a href=\"https://orcid.org/', paste0(sapply(seq(from=1, to=nchar(docentes$ORCID[i]), by=4),
                                                               function(j) substr(docentes$ORCID[i], j, j+3)), collapse = "-"),
                 '\">', paste0(sapply(seq(from=1, to=nchar(docentes$ORCID[i]), by=4),
                                     function(j) substr(docentes$ORCID[i], j, j+3)), collapse = "-"), '</a>', sep = ""),
           docentes$ORCID[i]),
    docentes$País[i]
  )
  table.2 <- rbind(table.2, table)
...
# Set column and row names
colnames(table.2) <- c("Nome", "Categoria", "Credenciamento", "Lattes ID", "ORCID", "País")
rownames(table.2) <- NULL
...
# Print tables
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table, title = "Pessoas - Docentes - 2024-2021")
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  cat(knitr::knit_print(create_dt(table, title = "Pessoas - Pós-Docs - 2024-2021")))
...
if (dim(discentes)[1] != 0) {
  ...
  table <- discentes[ids,]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Discentes - Doutorado")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(egressos)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Egressos - Titulados")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(egressos)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Egressos - 5 anos")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(egressos)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Egressos - 10 anos")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(egressos)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Egressos - Histórico")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(discentes)[1] != 0) {
  ...
  table <- discentes[ids,]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Discentes - Graduação")
} else {
  cat("*Sem dados para exibir*")
}
...
# print tables
print(
  knitr::kable(grupos.raw, align = c("l", rep(
    "c", ncol(grupos.raw) - 2
  ), "r"), escape = FALSE, format = "html") %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
...
# print tables
print(knitr::kable(grupos.raw, align = c("l", rep("c", ncol(grupos.raw)-2), "r"), escape = FALSE, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
# print tables
print(
  knitr::kable(membros.raw, align = c("l", rep(
...
if (dim(externos)[1] != 0) {
  ...
  table <- externos[ids,]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Participantes externos - Nacionais")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(externos)[1] != 0) {
  ...
  table <- externos[ids,]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Participantes externos - Internacionais")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(externos)[1] != 0) {
  ...
  table <- externos[ids,]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pessoas - Participantes externos - Instituições")
} else {
  cat("*Sem dados para exibir*")
}
