...
try(names(discentes) <- names(sucupira.list[[as.character(max(as.numeric(names(sucupira.list))))]]), silent = TRUE)
...
try(names(egressos) <- names(sucupira.list[[as.character(max(as.numeric(names(sucupira.list))))]]), silent = TRUE)
