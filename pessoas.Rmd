...
```{r docentes-atual-perfil, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
...
```{r coordenadores-2024, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.coordenadores")
id1 <-
  docentes.raw$Credenciamento <= 2024 &
  docentes.raw$Descredenciamento == "Atual"
id2 <-
...
```{r coordenadores-2020, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.coordenadores")
id1 <-
...
```{r coordenadores-2016, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.coordenadores")
id1 <-
...
```{r coordenadores-2012, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.coordenadores")
id1 <-
...
```{r docentes-2024-grafico, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2024 &
...
```{r docentes-2024-tabela, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2024 &
...
```{r docentes-2020-grafico, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2020 &
...
```{r docentes-2020-tabela, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2020 &
...
```{r docentes-2016-grafico, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2016 &
...
```{r docentes-2016-tabela, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2016 &
...
```{r docentes-2012-grafico, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2012 &
...
```{r docentes-2012-tabela, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2012 &
...
```{r pos-doc-2024, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2024 &
...
```{r pos-doc-2020, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2020 &
...
```{r pos-doc-2016, eval = has.docentes.posdocs}
docentes.raw <-
  read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
id1 <-
  docentes.raw$Credenciamento <= 2016 &
...
```{r pos-doc-2012, eval = has.docentes.posdocs}
docentes.raw <- read_excel("PPG/Docentes e Pós-Docs.xlsx", sheet = "DATA.colegiado")
...
membros.raw <- read_excel("PPG/Grupos de Pesquisa.xlsx", sheet = "DGP")
