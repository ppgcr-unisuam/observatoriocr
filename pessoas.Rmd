...
print(
  knitr::kable(table, align = c("l", rep("c", ncol(table) - 2), "r"), escape = FALSE) %>%
...
# print tables
print(knitr::kable(grupos.raw, align = c("l", rep("c", ncol(grupos.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
