...
```{r livros, eval = has.livros}
# bind sources
doi_unique <- doi_unique_livros
my_dois_works <- my_dois_works_livros
...
# bind sources
doi_unique <- doi_unique_capitulos
my_dois_works <- my_dois_works_capitulos
...
```{r retratacoes, eval = has.retratacoes}
# get years
source("Scripts/years-sucupira.R", local = knitr::knit_global())
# bind sources
doi_unique <- dois_unique_retracted
my_dois_works <- my_dois_works_retracted
