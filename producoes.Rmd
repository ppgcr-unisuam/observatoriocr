...
```{r editoria-tabela, eval = has.editoria.sucupira}
# produção
sheet <- "Produções - Autores"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
...
references <- references_editoria
colnames(references) <- c("ID", "Referência")
...
if (max(dim(doi_with_altmetric)[1], 0) == 0 &
  ...
  # print export buttons
  source("Scripts/print-only-buttons.R", local = knitr::knit_global())
  print_buttons_dt(references, title = "Editoria")
}
...
if (max(dim(doi_with_altmetric)[1], 0) == 0 &
  ...
  # print export buttons
  source("Scripts/print-only-buttons.R", local = knitr::knit_global())
  print_buttons_dt(references, title = "Trabalhos em Anais")
}
