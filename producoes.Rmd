...
```{r artigos-periodicos-tabela, eval = has.artigos.completos.sucupira}
# produção
...
# bind sources
doi_with_altmetric <- c(doi_with_altmetric_artigos, doi_with_altmetric_resumos)
doi_without_altmetric <- c(doi_without_altmetric_artigos, doi_without_altmetric_resumos)
references <- c(references_artigos, references_resumos)
...
```{r preprint-icons, eval = has.preprints.ppg}
# bind sources
...
```{r editoria-tabela, eval = has.livros.sucupira}
# produção
sheet <- "Produções - Autores"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
...
```{r livro-tabela, eval = has.livros.sucupira}
# produção
sheet <- "Produções - Autores"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
...
```{r livros-icon, eval = any(has.livros.ppg, has.livros.sucupira)}
# bind sources
...
```{r capitulo-icon, eval = has.capitulos.ppg}
# bind sources
...
```{r trabalho-anais-tabela, eval = has.anais.sucupira}
# produção 2
sheet <- "Produções - Autores"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
...
```{r trabalho-anais-icons, eval = has.anais.ppg}
# bind sources
...
```{r retratacao-icon, eval = has.producao.ppg}
# get years
source("Scripts/years-sucupira.R", local = knitr::knit_global())
# bind sources
...
if (max(dim(doi_with_altmetric)[1], 0) == 0 &
  ...
  # print export buttons
  source("Scripts/print-only-buttons.R", local = knitr::knit_global())
  print_buttons_dt(references, title = "Produções - Retratações")
}
