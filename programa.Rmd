...
<table>
  <tr>
    <td>
      [<img align="center" src="PPG/Images/logo-mestrado.png">](https://www.unisuam.edu.br/mestrado/mestrado-academico-em-ciencias-da-reabilitacao){target="_blank"}
      </td>
    <td>
      [<img align="center" src="PPG/Images/logo-doutorado.png">](https://www.unisuam.edu.br/doutorado-academico-em-ciencias-da-reabilitacao){target="_blank"}
    </td>
    <td>
      [<img align="center" src="PPG/Images/logo-posdoc.png">](https://www.unisuam.edu.br/pos-doutorado-academico-em-ciencias-da-reabilitacao){target="_blank"}
    </td>
  </tr>
</table>
...
<iframe src="https://sucupira.capes.gov.br/sucupira/public/consultas/coleta/programa/viewPrograma.jsf?popup=true&cd_programa=31063012002P4" style="width:100%; height:500px; border:0;"></iframe>

*Fontes:* [**Plataforma Sucupira**](https://sucupira.capes.gov.br/sucupira/public/consultas/coleta/programa/viewPrograma.jsf?popup=true&cd_programa=31063012002P4)
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(financiadores, title = "Financiadores 2024-2021")
```
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(financiadores, title = "Financiadores 2020-2017")
```
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(financiadores, title = "Financiadores 2016-2013")
```
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(financiadores, title = "Financiadores 2012-2010")
```
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(financiadores, title = "Financiadores 2010-pré")
```
