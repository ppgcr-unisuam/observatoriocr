...
<table>
  <tr>
    <td>
      [<img align="center" src="Images/MACR_logo.png">](https://www.unisuam.edu.br/mestrado/mestrado-academico-em-ciencias-da-reabilitacao){target="_blank"}
      </td>
    <td>
      [<img align="center" src="Images/DACR_logo.png">](https://www.unisuam.edu.br/doutorado-academico-em-ciencias-da-reabilitacao){target="_blank"}
    </td>
    <td>
      [<img align="center" src="Images/PDCR_logo.png">](https://www.unisuam.edu.br/pos-doutorado-academico-em-ciencias-da-reabilitacao){target="_blank"}
    </td>
  </tr>
</table>
...
```{r apresentacao, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
...
colnames(dados.do.programa.raw) <- seq(1:dim(dados.do.programa.raw)[2])
...
for(i in 1:dim(endereco.raw)[1]){
  if(length(grep("https://", endereco.raw[i,2])) != 0){
    endereco.raw[i,2] <- paste('[↗️](', endereco.raw[i,2], '){target="_blank"}', sep = "")
  }
}

# print tables
table <- unname(rbind(dados.do.programa.raw, endereco.raw))
...
```{r documentos-historicos-2020, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
quadrienal2017.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "2017-2020 Quadrienal", col_types = c("text"))

# replace the link by a tag
for(i in 1:dim(quadrienal2017.raw)[1]){
  quadrienal2017.raw[i,3] <- paste("[↗️](", quadrienal2017.raw[i,3], '){target="_blank"}', sep = "")
}

# print table
print(kable(quadrienal2017.raw, align = c("l", rep("c", ncol(quadrienal2017.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r documentos-historicos-2016, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
quadrienal2013.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "2013-2016 Quadrienal", col_types = c("text"))

# replace the link by a tag
for(i in 1:dim(quadrienal2013.raw)[1]){
  quadrienal2013.raw[i,3] <- paste("[↗️](", quadrienal2013.raw[i,3], '){target="_blank"}', sep = "")
}

# print table
print(kable(quadrienal2013.raw, align = c("l", rep("c", ncol(quadrienal2013.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r documentos-historicos-2012, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
trienal2010.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "2010-2012 Trienal", col_types = c("text"))

# replace the link by a tag
for(i in 1:dim(trienal2010.raw)[1]){
  trienal2010.raw[i,3] <- paste("[↗️](", trienal2010.raw[i,3], '){target="_blank"}', sep = "")
}

# print table
print(kable(trienal2010.raw, align = c("l", rep("c", ncol(trienal2010.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r documentos-historicos-2010, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
historico.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "2006-2010 APCN", col_types = c("text"))

# replace the link by a tag
for(i in 1:dim(historico.raw)[1]){
  historico.raw[i,3] <- paste("[↗️](", historico.raw[i,3], '){target="_blank"}', sep = "")
}

# print table
print(kable(historico.raw, align = c("l", rep("c", ncol(historico.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r area-concetracao, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
area.raw <- read_excel("../PPGCR Unisuam/Dados Cadastrais.xlsx", sheet = "AC", col_types = c("text"))
area.raw$Fim <- NULL

# print tables
print(kable(area.raw, align = c("l", rep("c", ncol(area.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r area-concetracao-inativas, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
areas.raw <- read_excel("../PPGCR Unisuam/Dados Cadastrais.xlsx", sheet = "AC", col_types = c("text"))
areas.inativas <- areas.raw[!is.na(areas.raw$Fim), ]
areas.inativas <- areas.inativas[order(areas.inativas$Fim, decreasing = TRUE), ]

# print tables
if(dim(areas.inativas)[1] !=0){
  print(kable(areas.inativas, align = c("l", rep("c", ncol(areas.inativas)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
} else {
...
```{r linhas-de-pesquisa-atual, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
linhas.raw <- read_excel("../PPGCR Unisuam/Dados Cadastrais.xlsx", sheet = "LP", col_types = c("text"))
linhas.atual <- linhas.raw[is.na(linhas.raw$Fim), ]
linhas.atual$Fim <- NULL

# print tables
print(kable(linhas.atual, align = c("l", rep("c", ncol(linhas.atual)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r linhas-de-pesquisa-inativas, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
linhas.inativas <- linhas.inativas[order(linhas.inativas$Fim, decreasing = TRUE), ]

# print tables
if(dim(linhas.inativas)[1] !=0){
  print(kable(linhas.inativas, align = c("l", rep("c", ncol(linhas.inativas)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
} else {
  cat("*Sem dados para exibir*")
}
...
```{r projetos-de-pesquisa-2024-grafico, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
projetos.raw.2012 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2012.xlsx", sheet = "Projetos - Membros")
projetos.raw.2013 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2013.xlsx", sheet = "Projetos - Membros")
projetos.raw.2014 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2014.xlsx", sheet = "Projetos - Membros")
projetos.raw.2015 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2015.xlsx", sheet = "Projetos - Membros")
projetos.raw.2016 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2016.xlsx", sheet = "Projetos - Membros")
projetos.raw.2017 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2017.xlsx", sheet = "Projetos - Membros")
projetos.raw.2018 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2018.xlsx", sheet = "Projetos - Membros")
projetos.raw.2019 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2019.xlsx", sheet = "Projetos - Membros")
projetos.raw.2020 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2020.xlsx", sheet = "Projetos - Membros")
projetos.raw.2021 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2021.xlsx", sheet = "Projetos - Membros")
projetos.raw.2022 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Projetos - Membros")
projetos.all <- rbind(projetos.raw.2012, projetos.raw.2013, projetos.raw.2014, projetos.raw.2015, projetos.raw.2016, projetos.raw.2017, projetos.raw.2018, projetos.raw.2019, projetos.raw.2020, projetos.raw.2021, projetos.raw.2022)
...
```{r projetos-de-pesquisa-2024-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
projetos.raw <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Projetos - Membros")
projetos <- projetos.raw[projetos.raw$`Membro Responsável`=="Sim" & projetos.raw$Situação == "EM ANDAMENTO", ]
...
```{r projetos-de-pesquisa-2024-lista, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
projetos.raw <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Projetos - Membros")
projetos <- projetos.raw[projetos.raw$`Membro Responsável`=="Sim", ]
projetos <- projetos[projetos$Situação=="EM ANDAMENTO", ]
...
```{r projetos-de-pesquisa-2020-grafico, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
projetos.raw.2019 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2019.xlsx", sheet = "Projetos - Membros")
projetos.raw.2020 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2020.xlsx", sheet = "Projetos - Membros")
projetos.all <- rbind(projetos.raw.2017, projetos.raw.2018, projetos.raw.2019, projetos.raw.2020)
...
```{r projetos-de-pesquisa-2020-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r projetos-de-pesquisa-2020-lista, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r projetos-de-pesquisa-2016-grafico, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
projetos.raw.2015 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2015.xlsx", sheet = "Projetos - Membros")
projetos.raw.2016 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2016.xlsx", sheet = "Projetos - Membros")
projetos.all <- rbind(projetos.raw.2013, projetos.raw.2014, projetos.raw.2015, projetos.raw.2016)
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "CONCLUÍDO", ]
...
```{r projetos-de-pesquisa-2016-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r projetos-de-pesquisa-2016-lista, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r projetos-de-pesquisa-concluidos-2012-grafico, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
projetos.raw.2012 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2012.xlsx", sheet = "Projetos - Membros")
projetos.all <- rbind(projetos.raw.2012)
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "CONCLUÍDO", ]
...
```{r projetos-de-pesquisa-concluidos-2012-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r projetos-de-pesquisa-2012-lista, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r financiadores-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
financiadores.raw <- read_excel("../PPGCR Unisuam/Financiadores.xlsx", sheet = "financiadores")
...
# par(oma=c(0.1, 2, 2, 0.1), mar = c(2, 2, 2, 0.1))
...
# barplot(total.ano[ , 2] ~ total.ano[ , 1], ylab = "Total (R$)", main = "Valores de financiamentos", col = brewer.pal(n = 3, name = "Set3")[1])
# 
# total.agencia <- aggregate(financiadores.raw$Total, by = list(financiadores.raw$'Agência'), FUN = sum, na.rm = TRUE)
# pie(total.agencia[ , 2], labels = NA, col = brewer.pal(n = unique(editais.agencia), name = "Set3"), init.angle = 90, main = "Agência", inset = -1)
# 
# # generate plot of total per year
# editais.ano <- aggregate(financiadores.raw$Total, by = list(financiadores.raw$Ano), FUN = function(x) sum(!is.na(x)))
# barplot(editais.ano[ , 2] ~ editais.ano[ , 1], ylab = "Editais", main = "Quantidade de editais financiados", col = brewer.pal(n = 3, name = "Set3")[1])
# pie(editais.agencia, labels = NA, col = brewer.pal(n = unique(editais.agencia), name = "Set3"), init.angle = 90, main = "Agência", inset = -1)
# 
# # generate plot of total per professor
# professores.ano <- rowSums(table(financiadores.raw$Ano, financiadores.raw$Proponente) != 0)
# barplot(professores.ano ~ names(professores.ano), ylab = "Docentes", main = "Quantidade de docentes com financiamentos", col = brewer.pal(n = 3, name = "Set3")[1])
# plot(0, type = 'n', axes = FALSE)
# legend("center", legend = names(editais.agencia), fill = brewer.pal(n = length(names(editais.agencia)), name = "Set3"), box.lwd = 0, cex = 1)
...
```{r historico-financiadores-2024, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r historico-financiadores-2020, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r historico-financiadores-2016, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r historico-financiadores-2012, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r historico-financiadores-2010, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r bolsas, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
turmas.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "PortariaBolsas", col_types = c("text"))
...
```{r cursos, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r creditos, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
creditos.raw <- read_excel("../PPGCR Unisuam/Dados Cadastrais.xlsx", sheet = "Créditos", col_types = c("text"))
...
```{r estrutura-academica-atual-grafico, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
disciplinas.raw <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Disciplinas")
...
pie(table(table.msc[, which(colnames(table.msc) == "Obrigatória")]), labels = NA, col = brewer.pal(n = unique(colnames(table.msc)), name = "Set3"), init.angle = 90, main = "Mestrado")
pie(table(table.dsc[, which(colnames(table.dsc) == "Obrigatória")]), labels = NA, col = brewer.pal(n = unique(colnames(table.dsc)), name = "Set3"), init.angle = 90, main = "Doutorado")
plot(0, type = 'n', axes = FALSE)
...
# # read separate sheets
# turmas.2022 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Turmas", )
# # bind all sheets
# turmas.raw <- turmas.2022
# # replace full names by initials
# 
...
```{r estrutura-academica-atual-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# layout(matrix(c(1,2,3), nrow = 1, byrow = TRUE), widths = c(0.4, 0.4, 0.2))
# par(oma=c(1, 1, 2, 0.1), mar = c(1, 1, 2, 1))
# # generate plot of total per course
# pie(table(table.msc[, which(colnames(table.msc) == "Obrigatória")]), labels = NA, col = brewer.pal(n = unique(colnames(table.msc)), name = "Set3"), init.angle = 90, main = "Mestrado")
# pie(table(table.dsc[, which(colnames(table.dsc) == "Obrigatória")]), labels = NA, col = brewer.pal(n = unique(colnames(table.dsc)), name = "Set3"), init.angle = 90, main = "Doutorado")
# plot(0, type = 'n', axes = FALSE)
...
<iframe src="https://drive.google.com/file/d/1gJ4ZkZHoBWUBAO_fbMeszyEllJwYwKrs/preview" style="width:100%; height:500px; border:0;"></iframe>
...
```{r bibliografia, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
bibliografia.raw <- read_excel("../PPGCR Unisuam/Bibliografia.xlsx", sheet = "Bibliografia", col_types = c("text"))
...
```{r bibliografia-ano, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r estrutura-academica-inativa-2020, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
disciplinas.raw.2022 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2021 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2021.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2020 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2020.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2019 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2019.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2018 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2018.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2017 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2017.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2016 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2016.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2015 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2015.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2014 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2014.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2013 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2013.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw.2012 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2012.xlsx", sheet = "Disciplinas", col_types = c("text"))
disciplinas.raw <- rbind(disciplinas.raw.2022, disciplinas.raw.2021, disciplinas.raw.2020, disciplinas.raw.2019, disciplinas.raw.2018, disciplinas.raw.2017, disciplinas.raw.2016, disciplinas.raw.2015, disciplinas.raw.2014, disciplinas.raw.2013, disciplinas.raw.2012)
disciplinas.raw <- disciplinas.raw[!is.na(disciplinas.raw$`Data de fim`), ]
...
```{r turmas-tabela, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis", out.width="100%"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r turmas-2024, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
turmas.2021 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2021.xlsx", sheet = "Turmas",  col_types = c("text"))
turmas.2022 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2022.xlsx", sheet = "Turmas", col_types = c("text"))
# bind all sheets
turmas.raw <- rbind(turmas.2021, turmas.2022)
...
```{r estrutura-academica-2024-docentes, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r turmas-2020, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
turmas.2017 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2017.xlsx", sheet = "Turmas",  col_types = c("text"))
turmas.2018 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2018.xlsx", sheet = "Turmas", col_types = c("text"))
turmas.2019 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2019.xlsx", sheet = "Turmas", col_types = c("text"))
turmas.2020 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2020.xlsx", sheet = "Turmas", col_types = c("text"))
# bind all sheets
turmas.raw <- rbind(turmas.2017, turmas.2018, turmas.2019, turmas.2020)
...
```{r turmas-2016, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
turmas.2013 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2013.xlsx", sheet = "Turmas", col_types = c("text"))
turmas.2014 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2014.xlsx", sheet = "Turmas", col_types = c("text"))
turmas.2015 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2015.xlsx", sheet = "Turmas", col_types = c("text"))
turmas.2016 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2016.xlsx", sheet = "Turmas", col_types = c("text"))
# bind all sheets
turmas.raw <- rbind(turmas.2013, turmas.2014, turmas.2015, turmas.2016)
...
```{r turmas-2012, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
turmas.2012 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2012.xlsx", sheet = "Turmas", col_types = c("text"))
# bind all sheets
turmas.raw <- rbind(turmas.2012)
...
```{r calendarios, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
turmas.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "Turmas", col_types = c("text"))
...
```{r laboratorios-descritivo, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
dados.lab <- read_excel("../PPGCR Unisuam/Laboratórios.xlsx", sheet = "Dados")

# print tables
print(kable(dados.lab, digits = 0, align = c("l", rep("c", ncol(dados.lab)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r laboratorios-equipamentos, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read data
labs <- read_excel("../PPGCR Unisuam/Laboratórios.xlsx", sheet = "Dados", col_types = c("text"))

for(i in 1:dim(labs)[1]){
  lab <- read_excel("../PPGCR Unisuam/Laboratórios.xlsx", sheet = paste("Lab", i, sep = ""))
  name <- names(lab[1])
  ...
  cat('<center>\n')
  cat('\n\n<!-- -->\n\n')
  print(kable(lab, digits = 0, align = c("l", rep("c", ncol(lab)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center")  %>% scroll_box(width = "100%", height = "250px"))
  cat('\n</center>')
  cat('</div></div>')
...
```{r laboratorios-planta, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r documentos-convenios-cefan, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
vigentes.raw <- read_excel("../PPGCR Unisuam/Convênios.xlsx", sheet = "CEFAN", col_types = c("text"))
...
```{r documentos-convenios-apb, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
vigentes.raw <- read_excel("../PPGCR Unisuam/Convênios.xlsx", sheet = "APB", col_types = c("text"))
...
```{r dinter-andamento, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
interinstitucional.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "Dinter2019", col_types = c("text"))

# replace the link by a tag
for(i in 1:dim(interinstitucional.raw)[1]){
  interinstitucional.raw[i,3] <- paste("[↗️](", interinstitucional.raw[i,3], '){target="_blank"}', sep = "")
}

# print table
print(kable(interinstitucional.raw, align = c("l", rep("c", ncol(interinstitucional.raw)-2), "r")) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = T, position = "center"))
...
```{r minter-andamento, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
interinstitucional.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "PCI2021", col_types = c("text"))
...
```{r minter-concluido, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
# read separate sheets
interinstitucional.raw <- read_excel("../PPGCR Unisuam/Documentos.xlsx", sheet = "Minter2019", col_types = c("text"))
