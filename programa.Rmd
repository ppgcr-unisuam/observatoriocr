...
## **Apresentação** {.tabset #Apresentação}
...
## **Breve histórico** {.tabset #BreveHistorico}
...
## **Área de concentração** {.tabset #AC}
...
## **Projetos de pesquisa** {.tabset #PP}
...
projetos.raw <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2021.xlsx", sheet = "Projetos - Membros")
...
## **Estrutura curricular** {.tabset #EstruturaCurricular}
...
# read separate sheets
disciplinas.raw <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2021.xlsx", sheet = "Disciplinas")
...
# # read separate sheets
# turmas.2021 <- read_excel("../PPGCR Unisuam/Sucupira/conferencia_programa_2021.xlsx", sheet = "Turmas", )
# # bind all sheets
# turmas.raw <- turmas.2021
...
# read separate sheets
bibliografia.raw <- read_excel("../PPGCR Unisuam/Estrutura curricular.xlsx", sheet = "Bibliografia", col_types = c("text"))
...
disciplinas.raw <- rbind(disciplinas.raw.2020, disciplinas.raw.2019, disciplinas.raw.2018, disciplinas.raw.2017, disciplinas.raw.2016, disciplinas.raw.2015, disciplinas.raw.2014, disciplinas.raw.2013, disciplinas.raw.2012)
disciplinas.raw <- disciplinas.raw[!is.na(disciplinas.raw$`Data de fim`), ]
...
## **Calendários** {.tabset #Calendários}
...
## **Convênios institucionais** {#Convênios}
...
## **Cooperação entre instituições** {.tabset #Cooperação}
