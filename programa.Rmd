...
```{r estrutura-academica-inativa, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r turmas-disciplinas-2024, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
...
```{r turmas-docentes-2024, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
options(knitr.kable.NA = '--', knitr.table.format = "html")
