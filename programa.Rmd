...
```{r ementas}
# read separate sheets
bibliografia.raw <- read_excel("PPG/Bibliografia.xlsx", sheet = "Ementas", col_types = c("text"))
link_ementas <- bibliografia.raw[,3]
```

<iframe src="`r link_ementas`" style="width:100%; height:500px; border:0;"></iframe>
