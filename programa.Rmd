...
# read separate sheets
turmas.raw <- read_excel("PPG/Documentos.xlsx", sheet = "Turmas", col_types = c("text"))
...
# read separate sheets
interinstitucional.raw <- read_excel("PPG/Documentos.xlsx", sheet = "Dinter2019", col_types = c("text"))
...
# read separate sheets
interinstitucional.raw <- read_excel("PPG/Documentos.xlsx", sheet = "PCI2021", col_types = c("text"))
...
# read separate sheets
interinstitucional.raw <- read_excel("PPG/Documentos.xlsx", sheet = "Minter2019", col_types = c("text"))
