...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table.projetos, title = "Programa - Projetos de Pesquisa - Em andamento")
...
print(
  knitr::kable(cursos, align = c("l", rep("c", ncol(
    cursos
  ) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
  )
...
# print tables
print(
  knitr::kable(creditos.raw, align = c("l", rep(
...
has.avaliacao <- as.logical(length(periodos) != 0)
```
...
if (dim(turmas.raw)[1] != 0) {
  ...
  print(
    knitr::kable(turmas.oferecidas, align = c("l", rep(
...
for (j in 1:length(abas)) {
  ...
  if (dim(calendarios)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    cat(knitr::knit_print(create_dt(calendarios, title = "Programa - Calendários")))
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (j in 1:length(abas)) {
  ...
  if (dim(editais)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    cat(knitr::knit_print(create_dt(editais, title = "Programa - Editais")))
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (j in 1:length(abas)) {
  ...
  if (dim(infraestrutura.raw)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    cat(knitr::knit_print(create_dt(infraestrutura.raw, title = "Programa - Infraestrutura")))
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (i in 1:length(abas)) {
  ...
  cat('\n\n<!-- -->\n\n')
  print(
    knitr::kable(lab, digits = 0, align = c("l", rep("c", ncol(
      lab
    ) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>% kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = T,
...
for (j in 1:length(abas)) {
  ...
  if (dim(convenios)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    cat(knitr::knit_print(create_dt(convenios, title = "Programa - Convênios institucionais")))
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (j in 1:length(abas)) {
  ...
  if (dim(cooperacoes)[1] != 0) {
    ...
    cat(knitr::knit_print(
      create_dt(cooperacoes, title = "Programa - Cooperação interinstitucional")
    ))
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (j in 1:length(abas)) {
  ...
  if (dim(internacional)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    cat(knitr::knit_print(create_dt(internacional, title = "Programa - Internacionalização")))
  } else {
    cat("*Sem dados para exibir*")
  }
...
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
try(create_dt(financiadores, title = "Programa - Financiadores - 2024-2021"),
    silent = TRUE)
...
for (j in 1:length(abas)) {
  ...
  if (dim(bolsas.raw)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    cat(knitr::knit_print(create_dt(bolsas.raw, title = "Programa - Bolsas de estudo")))
  } else {
    cat("*Sem dados para exibir*")
  }
