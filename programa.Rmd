...
```{r apresentacao, eval = has.dados.cadastrais}
...
```{r documentos-historicos-2020, eval = has.apresentacao}
# read separate sheets
quadrienal2017.raw <-
...
```{r documentos-historicos-2016, eval = has.apresentacao}
# read separate sheets
quadrienal2013.raw <-
  read_excel("PPG/Apresentação.xlsx",
...
```{r documentos-historicos-2012, eval = has.apresentacao}
# read separate sheets
trienal2010.raw <-
  read_excel("PPG/Apresentação.xlsx",
...
```{r documentos-historicos-2010, eval = has.apresentacao}
# read separate sheets
historico.raw <-
  read_excel("PPG/Apresentação.xlsx",
